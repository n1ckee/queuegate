...
extension Queue : DocumentSerializable {
	init?(dictionary: [String : Any]) {
		...
		self.init(documentId: nil, currentTicketId: currentTicketId, lastTicketNumber: lastTicketNumber, name: name, organizationId: organizationId, status: status, ticketCount: nil)
	}
	...
	init?(documentId: String, dictionary: [String : Any]) {
		...
		self.init(documentId: documentId, currentTicketId: currentTicketId, lastTicketNumber: lastTicketNumber, name: name, organizationId: organizationId, status: status, ticketCount: nil)
	}
}
