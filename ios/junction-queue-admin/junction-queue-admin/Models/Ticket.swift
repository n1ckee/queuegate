...
extension Ticket : DocumentSerializable {
	init?(dictionary: [String : Any]) {
		...
		self.init(documentId: nil, approxCallTime: approxCallTime, queueId: queueId, ticketNumber: ticketNumber)
	}
	...
	init?(documentId: String, dictionary: [String : Any]) {
		...
		self.init(documentId: documentId, approxCallTime: approxCallTime, queueId: queueId, ticketNumber: ticketNumber)
	}
}
